...
namespace engine
{
  ...
  void stats::inc_ray_triangle_intersection()
  {
#if USE_STAT
    ray_triangle_intersection++;
#endif
  }
  void stats::inc_ray_box_intersection()
  {
#if USE_STAT
    ray_box_intersection++;
#endif
  }
  void stats::inc_ray_object_intersection()
  {
#if USE_STAT
    ray_object_intersection++;
#endif
  }
  uint64_t stats::get_ray_count()
  {
    return rays;
  }
  uint64_t stats::get_ray_triangle_intersection_count()
  {
    return ray_triangle_intersection;
  }
  uint64_t stats::get_ray_box_intersection_count()
  {
    return ray_box_intersection;
  }
  uint64_t stats::get_ray_object_intersection_count()
  {

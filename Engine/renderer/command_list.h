...
namespace engine
{
  ...
  struct ENGINE_API fgraphics_command_list
  {
    ...
    void set_render_targets(fdescriptor_heap& dsv_descriptor_heap, ID3D12DescriptorHeap* rtv_descriptor_heap, int back_buffer_index) const;
    ...
    void clear_depth_stencil(fdescriptor_heap& dsv_descriptor_heap) const;

...
namespace engine
{
  ...
  struct ENGINE_API fdevice final
  {
    ...
    void create_render_target(IDXGISwapChain4* swap_chain, uint32_t swap_chain_buffer_id, fdescriptor_heap& descriptor_heap, frtv_resource& out_rtv, const char* name) const;
    ...
    void create_render_target_descriptor_heap(uint32_t back_buffer_count, fdescriptor_heap& out_descriptor_heap, const char* name) const;

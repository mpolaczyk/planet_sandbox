...
namespace engine
{
  ...
  bool ENGINE_API load_obj_wavefront(const std::string& file_name, astatic_mesh* out_static_mesh);
  bool ENGINE_API load_obj_assimp(const std::string& file_name, astatic_mesh* out_static_mesh);

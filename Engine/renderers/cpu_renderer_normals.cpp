...
namespace engine
{
  OBJECT_DEFINE(rcpu_normals, rcpu, CPU renderer normals)
  OBJECT_DEFINE_SPAWN(rcpu_normals)

  void rcpu_normals::worker_job_update()
  {
  ...
  void rcpu_normals::render_chunk(const fchunk& in_chunk)
  {

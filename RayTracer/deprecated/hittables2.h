...
public:
  ...
  engine::soft_asset_ptr<engine::material_asset> material_asset;
...
public:
  ...
  xy_rect(float _x0, float _x1, float _y0, float _y1, float _z)
    : x0(_x0), x1(_x1), y0(_y0), y1(_y1), z(_z), hittable(hittable_type::xy_rect) { };
...
public:
  ...
  xz_rect(float _x0, float _x1, float _z0, float _z1, float _y)
    : x0(_x0), x1(_x1), z0(_z0), z1(_z1), y(_y), hittable(hittable_type::xz_rect) { };
...
public:
  ...
  yz_rect(float _y0, float _y1, float _z0, float _z1, float _x)
    : y0(_y0), y1(_y1), z0(_z0), z1(_z1), x(_x), hittable(hittable_type::yz_rect) { };
...
public:
  ...
  soft_asset_ptr<engine::static_mesh_asset> mesh_asset;

  // Runtime state
  engine::static_mesh_asset* runtime_asset;  // Vertices translated to the world coordinates

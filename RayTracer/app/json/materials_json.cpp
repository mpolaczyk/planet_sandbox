...
nlohmann::json material_instances_serializer::serialize(const asset_instances<material>* value)
{
...
void material_instances_serializer::deserialize(const nlohmann::json& j, asset_instances<material>* out_value)
{
